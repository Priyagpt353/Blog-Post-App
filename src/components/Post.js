 ...
 return(
    <div>
        <Container className='mt-2'>
            <Row>
                <Col lg={9}>
                    <Link to={`/`} className='m-3 btn btn-link' color="link">back to index</Link>
                </Col>
                <Col lg={1}>
                <Button onClick={likePost} id='likepost' className={[likeActive?'active-like':null,'button'].join('')}><FaHeart />{like}</Button>
                </Col>
                <Col lg={1}>
